...
public final class StringValidator {
    ...
    public final static String TITLE_PATTERN_EN_RUS = "^[- _A-Za-zА-Яа-я0-9]+$";
    public final static String TITLE_PATTERN_EN = "^[- _A-Za-z0-9]+$";
    public final static String TEXT_PATTERN = "^[^<>&]+$";
